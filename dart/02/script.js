...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    printConsole(e) {
      e.preventDefault();
      A.printString("clicked on: " + J.toString$0$($.link));
    },
    main() {
      var t2,
        t1 = $.link = document.querySelector("#link");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(A.link__printConsole$closure()), false, t2._precomputed1);
      }
    }
  },
  B = {};
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "link__printConsole$closure", "printConsole", 3);
  })();
